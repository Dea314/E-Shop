    ...
    <Container>
      ...
      <Row className="mt-5">
        <Col style={{ zIndex: 1 }} md={4}>
          <div id="first">
            <Image crossOrigin="anonymous" fluid src="/img/books.png" />
          </div>
          <br />
          <div id="second">
            <Image fluid src="/img/cams.png" />
          </div>
          <br />
          <div id="third">
            <Image fluid src="/img/ebooks.png" />
          </div>
          <br />
          <div id="fourth">
            <Image fluid src="/img/electronix.png" />
          </div>
          <br />
          <div id="fifth">
            <Image fluid src="/img/games.png" />
          </div>
          <br />
          <div id="sixt">
            <Image fluid src="/img/toys.png" />
          </div>
          <br />
        </Col>
        <Col md={8}>
